...
│   ├── core/             # Core abstractions: device, geometry, containers
│   ├── io/               # Readers, writers, path config
│   ├── preprocessing/    # Bed removal, cropping, unit conversion
│   ├── projection/       # X-ray projection engines and physics models
│   ├── reconstruction/   # FDK and tomosynthesis reconstruction steps
│   └── utility/          # Interpolation, visualization, helpers
└── results/       # Output generated by SaveManager
